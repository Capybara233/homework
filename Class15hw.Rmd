...
the bacteria came back again after switching the vaccine 
...
No
For FIM2/3, ap is little bit higher than wp in later time courses but it's not a huge differences. 
...
visit 4 reach at the maximum level but droppedn immediately 

>Q20. Does this pattern in time match the trend of antibody titer data? If not, why not?

no, antibody titer data peak at visit 5 and stay at high level for a while
Cells make antibodies, which are long lived. mRNA is short lived
...
rnaseq <- read.csv("~/Downloads/class 15/2020LD_rnaseq.csv")
